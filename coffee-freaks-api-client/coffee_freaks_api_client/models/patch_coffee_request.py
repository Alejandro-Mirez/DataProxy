...
class PatchCoffeeRequest:
    ...
    speciality: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if speciality is not UNSET:
            field_dict["speciality"] = speciality
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        speciality = d.pop("speciality", UNSET)
        ...
        patch_coffee_request.additional_properties = d
        return patch_coffee_request
