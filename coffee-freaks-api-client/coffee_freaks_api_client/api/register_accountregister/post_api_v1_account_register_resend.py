...
from ...models.registration_resend_request import RegistrationResendRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: RegistrationResendRequest,
    x_coffee_request_id: Union[Unset, str] = UNSET,

) -> Dict[str, Any]:
    url = "{}/api/v1/account/register/resend".format(
        client.base_url)
...
def sync(
    *,
    ...
    Returns:
        Union[BadRequest, InvalidInput, ServerError, SuccessResult]
     """
