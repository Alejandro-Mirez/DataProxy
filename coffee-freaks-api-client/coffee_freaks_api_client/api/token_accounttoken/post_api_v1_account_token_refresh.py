...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/account/token/refresh".format(
        client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[BadRequest, ServerError, TokenResult, Unauthorized]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[BadRequest, ServerError, TokenResult, Unauthorized]]:
    return Response(
...
) -> Response[Union[BadRequest, ServerError, TokenResult, Unauthorized]]:
    """ Refresh auth token
...
def sync(
    *,
...
) -> Optional[Union[BadRequest, ServerError, TokenResult, Unauthorized]]:
    """ Refresh auth token
    ...
    Returns:
        Union[BadRequest, ServerError, TokenResult, Unauthorized]
     """
