...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/email/{emailId}/send".format(
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[BadRequest, NotFound, ServerError, SuccessResult, Unauthorized]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[BadRequest, NotFound, ServerError, SuccessResult, Unauthorized]]:
    return Response(
...
) -> Response[Union[BadRequest, NotFound, ServerError, SuccessResult, Unauthorized]]:
...
def sync(
    ...
    *,
...
) -> Optional[Union[BadRequest, NotFound, ServerError, SuccessResult, Unauthorized]]:
    """  Trigger sending email
    ...
    Returns:
        Union[BadRequest, NotFound, ServerError, SuccessResult, Unauthorized]
     """
