...
class LoginRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["login", "password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["login", "password", ], str]):
