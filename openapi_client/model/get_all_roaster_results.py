...
class GetAllRoasterResults(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def parameters() -> typing.Type['GetAllRoasterParameters']:
                return GetAllRoasterParameters
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RoasterResult']:
                        return RoasterResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RoasterResult'], typing.List['RoasterResult']],
                ...
                def __getitem__(self, i: int) -> 'RoasterResult':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["parameters"]) -> 'GetAllRoasterParameters': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["parameters"]) -> 'GetAllRoasterParameters': ...
