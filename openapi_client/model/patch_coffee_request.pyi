...
class PatchCoffeeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "grammage", "origin", "kind", "beans", "processing", "roastingLevel", "dedicated", "description", "speciality", "roastingDates", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["grammage"]) -> typing.Union['Grammage', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["speciality"]) -> typing.Union[MetaOapg.properties.speciality, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "grammage", "origin", "kind", "beans", "processing", "roastingLevel", "dedicated", "description", "speciality", "roastingDates", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        grammage: typing.Union['Grammage', schemas.Unset] = schemas.unset,
        ...
        speciality: typing.Union[MetaOapg.properties.speciality, bool, schemas.Unset] = schemas.unset,
