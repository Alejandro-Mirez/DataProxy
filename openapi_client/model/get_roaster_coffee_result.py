...
class GetRoasterCoffeeResult(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def parameters() -> typing.Type['GetRoasterCoffeeParameters']:
                return GetRoasterCoffeeParameters
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CoffeeResult']:
                        return CoffeeResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CoffeeResult'], typing.List['CoffeeResult']],
                ...
                def __getitem__(self, i: int) -> 'CoffeeResult':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["parameters"]) -> 'GetRoasterCoffeeParameters': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["parameters"]) -> 'GetRoasterCoffeeParameters': ...
