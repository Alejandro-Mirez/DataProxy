...
class CoffeeRequestEntity(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "grammage", "kind", "speciality", "origin", "beans", "processing", "roastingLevel", "dedicated", "description", "roastingDates", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "grammage", "kind", "speciality", "origin", "beans", "processing", "roastingLevel", "dedicated", "description", "roastingDates", ], str]):
