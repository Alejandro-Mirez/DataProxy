...
class SuccessResult(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def status() -> typing.Type['SimpleResultStatus']:
                return SimpleResultStatus
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'SimpleResultStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> 'SimpleResultStatus': ...
