...
class InvalidInput(
        ...
        class properties:
            ...
            class fields(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['InvalidField']:
                        return InvalidField
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['InvalidField'], typing.List['InvalidField']],
                ...
                def __getitem__(self, i: int) -> 'InvalidField':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "fields", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "fields", ], str]):
