...
class GetAllRoasterParameters(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["limit", "offset", "created", "updated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["limit", "offset", "created", "updated", ], str]):
