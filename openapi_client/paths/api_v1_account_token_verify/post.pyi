...
SchemaFor200ResponseBodyApplicationJson = ValidTokenResult
...
SchemaFor400ResponseBodyApplicationJson = InvalidToken
...
class BaseApi(api_client.Api):
    @typing.overload
    def _post_api_v1_account_token_verify_oapg(
        self,
...
class PostApiV1AccountTokenVerify(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_api_v1_account_token_verify(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        cookie_params: RequestCookieParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_api_v1_account_token_verify(
        ...
        return self._post_api_v1_account_token_verify_oapg(
