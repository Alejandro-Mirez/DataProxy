...
# body param
SchemaForRequestBodyApplicationJson = ResetPasswordInput


request_body_reset_password_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _post_api_v1_account_password_reset_oapg(
        self,
    ...
    def _post_api_v1_account_password_reset_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_reset_password_input.serialize(body, content_type)
...
class PostApiV1AccountPasswordReset(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_api_v1_account_password_reset(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def post_api_v1_account_password_reset(
        ...
        return self._post_api_v1_account_password_reset_oapg(
            body=body,
