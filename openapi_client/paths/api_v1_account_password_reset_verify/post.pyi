...
# body param
SchemaForRequestBodyApplicationJson = ChangePasswordRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _post_api_v1_account_password_reset_verify_oapg(
        self,
...
class PostApiV1AccountPasswordResetVerify(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_api_v1_account_password_reset_verify(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def post_api_v1_account_password_reset_verify(
        ...
        return self._post_api_v1_account_password_reset_verify_oapg(
            body=body,
