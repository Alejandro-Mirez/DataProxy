...
SchemaFor200ResponseBodyApplicationJson = RoasterResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_api_v1_roaster_roasterid_oapg(
        self,
...
class GetApiV1RoasterRoasterid(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_api_v1_roaster_roasterid(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_api_v1_roaster_roasterid(
        ...
        return self._get_api_v1_roaster_roasterid_oapg(
