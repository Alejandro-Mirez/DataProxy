...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_api_v1_roaster_roasterid_oapg(
        self,
...
class DeleteApiV1RoasterRoasterid(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_api_v1_roaster_roasterid(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        cookie_params: RequestCookieParams = frozendict.frozendict(),
    ...
    def delete_api_v1_roaster_roasterid(
        ...
        return self._delete_api_v1_roaster_roasterid_oapg(
