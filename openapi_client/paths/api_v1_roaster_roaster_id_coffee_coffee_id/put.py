...
class BaseApi(api_client.Api):
    @typing.overload
    def _put_api_v1_roaster_roasterid_coffee_coffeeid_oapg(
        self,
...
class PutApiV1RoasterRoasteridCoffeeCoffeeid(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def put_api_v1_roaster_roasterid_coffee_coffeeid(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def put_api_v1_roaster_roasterid_coffee_coffeeid(
        ...
        return self._put_api_v1_roaster_roasterid_coffee_coffeeid_oapg(
            body=body,
