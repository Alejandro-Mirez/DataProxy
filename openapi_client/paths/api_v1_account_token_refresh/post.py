...
RequestOptionalHeaderParams = typing_extensions.TypedDict(
    'RequestOptionalHeaderParams',
    {
        ...
        'X-Coffee-Refresh-Auth': typing.Union[XCoffeeRefreshAuthSchema, str, ],
    },
    total=False
)
...
request_header_x_coffee_refresh_auth = api_client.HeaderParameter(
    name="X-Coffee-Refresh-Auth",
    style=api_client.ParameterStyle.SIMPLE,
    schema=XCoffeeRefreshAuthSchema,
)
# Cookie params
CoffeeAuthRefreshSchema = schemas.StrSchema
...
RequestOptionalCookieParams = typing_extensions.TypedDict(
    ...
    {
        'coffee_auth_refresh': typing.Union[CoffeeAuthRefreshSchema, str, ],
    },
    total=False
)
...
request_cookie_coffee_auth_refresh = api_client.CookieParameter(
    name="coffee_auth_refresh",
    style=api_client.ParameterStyle.FORM,
    schema=CoffeeAuthRefreshSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _post_api_v1_account_token_refresh_oapg(
        self,
    ...
    def _post_api_v1_account_token_refresh_oapg(
        ...
        for parameter in (
            ...
            request_header_x_coffee_refresh_auth,
        ):
...
class PostApiV1AccountTokenRefresh(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_api_v1_account_token_refresh(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        cookie_params: RequestCookieParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_api_v1_account_token_refresh(
        ...
        return self._post_api_v1_account_token_refresh_oapg(
