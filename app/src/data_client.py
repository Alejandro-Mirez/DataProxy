...
from coffee_freaks_api_client.api.authentication_account import post_api_v1_account_login, get_api_v1_account_logout
from coffee_freaks_api_client.api.coffee_coffee import get_api_v1_coffee, get_api_v1_roaster_roasterid_coffee_coffeeid, \
    post_api_v1_roaster_roasterid_coffee, put_api_v1_roaster_roasterid_coffee_coffeeid, \
    delete_api_v1_roaster_roasterid_coffee_coffeeid, post_api_v1_roaster_roasterid_coffee_coffeeid_image
from coffee_freaks_api_client.api.roaster_roaster import get_api_v1_roaster, get_api_v1_roaster_roasterid, \
    post_api_v1_roaster, put_api_v1_roaster_roasterid, delete_api_v1_roaster_roasterid
from coffee_freaks_api_client.api.token_accounttoken import post_api_v1_account_token_refresh
from coffee_freaks_api_client.models import LoginRequest, BadRequest, InvalidInput, ServerError, TokenResult, \
    ...
    AddCoffeeFile
from coffee_freaks_api_client.types import Response, File
...
class DataClient:
    ...
    def insert_coffee_image(self, roaster_id: str, coffee_id: str, file: UploadFile):
        self.logger.info(f"Sending image to ${roaster_id}/{coffee_id}")
        file_obj = File(
            payload=file.file,
            file_name=file.filename,
            mime_type=file.content_type
        )
        data = AddCoffeeFile(image=file_obj, filename=file.filename, category="lead")
        result = self.__safe_call(
            lambda *args: post_api_v1_roaster_roasterid_coffee_coffeeid_image.sync(
                roaster_id=roaster_id,
                coffee_id=coffee_id,
                multipart_data=data,
                x_coffee_auth=self.__auth_token,
